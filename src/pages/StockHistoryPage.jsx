...
const StockHistoryPage = () => {
  ...
  const history = stockHistory.filter((h) => h.name === name);
              ...
              {history.map((h) => {
                ...
                return (
                  <tr key={h.id} className="hover:bg-gray-50">
                    ...
                    <td className="border px-2 py-1 text-center">{h.satuan}</td>
                    <td className="border px-2 py-1 text-right">{rupiah(h.price)}</td>
                  </tr>
                );
              })}
            </tbody>
